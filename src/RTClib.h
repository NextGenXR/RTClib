...
enum RTC_Type {
	DS1307, DS3231, PCF8523, PCF8563, STM32
};
...
public:
	...
	void init(void);		// Initialize the RTC Hardware, if needed
	...
	bool now(RTC_DateTypeDef *sdatestructureget,
			RTC_TimeTypeDef *stimestructureget);

private:
	// Use a battery-backed hardware RTC as a backup clock.
	// Set any time the main clock is set
	bool backup_rtc(RTC_Type rtc, I2C_HandleTypeDef *Handle,
